...
namespace WebPartsTCE.FaleConoscoMPC
{
    [ToolboxItemAttribute(false)]
    public partial class FaleConoscoMPC : WebPart
    {
        ...
        protected void btnEnviarEmail_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                msg.From = address;
                msg.CC.Add("mpc@tce.se.gov.br");
                msg.Subject = "Formulario de Contato - (Site MPC - Ministério Público de Contas de Sergipe)";
                msg.IsBodyHtml = true;
                msg.Body = bodyHTML(nome, email, fone, cpf, assunto, mensagem).ToString();
        ...
        public StringBuilder bodyHTML(string nome, string email, string fone, string cpf, string assunto, string mensagem)
        {
