...
namespace WebPartsTCE.NoticiaPrincipalMPC
{
    [ToolboxItemAttribute(false)]
    public partial class NoticiaPrincipalMPC : WebPart
    {
            ...
            try
            {
                using (SPSite site = new SPSite("http://novosite.tce.se.gov.br"))
                {
                    using (SPWeb web = site.RootWeb)
                    {
                        ...
                        {
                            sbNoticia.Append("<li>");
                            sbNoticia.Append("   <a href=\"noticia.aspx?postID=" + item["ID"].ToString() + "\">");
