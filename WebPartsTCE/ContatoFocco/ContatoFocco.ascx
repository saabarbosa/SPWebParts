...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ContatoFocco.ascx.cs" Inherits="WebPartsTCE.ContatoFocco.ContatoFocco" %>
...
<div class="form-group">
    ...
    <div class="col-md-6">
        <label>Município*</label><asp:TextBox ID="tbxMunicipio" runat="server" class="form-control" required="true" maxlength="14" placeholder="Entre com o município."></asp:TextBox></div>
</div>
</div>
<div class="row">
<div class="form-group">
