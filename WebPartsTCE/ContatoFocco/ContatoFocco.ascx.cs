...
namespace WebPartsTCE.ContatoFocco
{
    [ToolboxItemAttribute(false)]
    public partial class ContatoFocco : WebPart
    {
        ...
        protected void btnEnviarEmail_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                msg.Subject = "Formulario de Contato - (Site FOCCO - Fórum de Combate à Corrupção de Sergipe)";
                msg.IsBodyHtml = true;
                msg.Body = bodyHTML(nome, email, fone, municipio, assunto, mensagem).ToString();
        ...
        public StringBuilder bodyHTML(string nome, string email, string fone, string municipio, string assunto, string mensagem)
        {
